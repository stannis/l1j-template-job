	...
	private class RaceTimer extends TimerTask {
		...
		public void run() {
			...
			try {
				...
				for (int i = 0; i < 5; i++) {
					L1ShopItem shopItem1 = new L1ShopItem(40309, 500, 1, 0, null); // 道具天數刪除系統
					shopItem1.setName(i);
					L1ShopItem shopItem2 = new L1ShopItem(40309, 500, 1, 0, null); // 道具天數刪除系統
					shopItem2.setName(i);
					L1ShopItem shopItem3 = new L1ShopItem(40309, 500, 1, 0, null); // 道具天數刪除系統
					shopItem3.setName(i);
