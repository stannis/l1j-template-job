	...
	private void countdown() {
		...
		try {
			while (secondsShut > 0) {
				...
				switch (secondsShut) {
				case 240:
					_an.announceToAll("伺服器將於 4 分鐘後爆炸!!請至安全區域準備登出。");
					 System.out.println( "伺服器將於 4 分鐘後爆炸!!" );     
					break;
				case 180:
					_an.announceToAll("伺服器將於 3 分鐘後爆炸!!請至安全區域準備登出。");
					 System.out.println( "伺服器將於 3 分鐘後爆炸!!" );     
					break;
				case 120:
					_an.announceToAll("伺服器將於 2 分鐘後爆炸!!請至安全區域準備登出。");
					 System.out.println( "伺服器將於 2 分鐘後爆炸!!" );     
					break;
				case 60:
					_an.announceToAll("伺服器將於 1 分鐘後爆炸!!請至安全區域準備登出。");
					 System.out.println( "伺服器將於 1 分鐘後爆炸!!" );     
					break;
				case 30:
					_an.announceToAll("伺服器將於 30 秒後爆炸!!");
					 System.out.println( "伺服器將於 30 秒後爆炸!!" );     
					break;
				case 10:
					_an.announceToAll("伺服器將於 10 秒後爆炸!!");
					 System.out.println( "伺服器將於 10 秒後爆炸!!" );     
					break;
				case 5:
					_an.announceToAll("伺服器將於 5 秒後爆炸!!");
					 System.out.println( "伺服器將於 5 秒後爆炸!!" );     
					break;
				case 4:
					_an.announceToAll("伺服器將於 4 秒後爆炸!!");
					 System.out.println( "伺服器將於 4 秒後爆炸!!" );     
					break;
				case 3:
					_an.announceToAll("伺服器將於 3 秒後爆炸!!");
					 System.out.println( "伺服器將於 3 秒後爆炸!!" );     
					break;
				case 2:
					_an.announceToAll("伺服器將於 2 秒後爆炸!!");
					 System.out.println( "伺服器將於 2 秒後爆炸!!" );     
					break;
				case 1:
					_an.announceToAll("伺服器將於 1 秒後爆炸!!");
					 System.out.println( "伺服器將於 1 秒後爆炸!!" );     
					break;
				}
