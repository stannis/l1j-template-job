...
import static l1j.server.server.model.skill.L1SkillId.LOGIN_EIN_TIME; // 殷海薩的祝福
...
public class C_LoginToServer extends ClientBasePacket {
	...
	public C_LoginToServer(byte abyte0[], ClientThread client)
		...
		// end
		// 玩家上線是否通知在線ＧＭ by xxyyzzxyz & 夜貓子 5/5
